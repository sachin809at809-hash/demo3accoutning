...
Route::group(['as' => 'ai.', 'prefix' => 'ai-assistant'], function () {
    Route::get('/', 'Common\AIAssistant@index')->name('index');
    Route::post('upload', 'Common\AIAssistant@upload')->name('upload');
    Route::get('history', 'Common\AIAssistant@history')->name('history');
    Route::post('insights', 'Common\AIAssistant@insights')->name('insights');
});
